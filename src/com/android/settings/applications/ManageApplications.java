...
public class ManageApplications extends Fragment implements
    ...
    public static final int APP_MOVING_ENABLE = MENU_OPTIONS_BASE + 9;
    public static final int APP_MOVING_DISABLE = MENU_OPTIONS_BASE + 10;
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (!Utils.isRestrictedProfile(getActivity())) {
            menu.add(0, SHOW_PROTECTED_APPS, 8, R.string.protected_apps)
                    .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
        }
        updateOptionsMenu();
    }
