...
import com.android.settings.chameleonos.ActiveDisplaySettings;
import com.android.settings.crdroid.HoverSettings;
import com.android.settings.crdroid.LockscreenNotifications;
import com.android.settings.paranoid.Halo;
import com.android.settings.spirit.HeadsUpSettings;
import com.android.settings.spirit.TtsNotification;
...
public class NotificationSettings extends SettingsPreferenceFragment {
    ...
    class StatusBarAdapter extends FragmentPagerAdapter {
        ...
        public StatusBarAdapter(FragmentManager fm) {
            ...
            frags[3] = new HoverSettings();
            frags[4] = new TtsNotification();
            frags[5] = new LockscreenNotifications();
        }
    ...
    private String[] getTitles() {
        ...
        titleString = new String[] {
                    getString(R.string.ad_settings_title),
                    getString(R.string.halo_settings_title),
                    getString(R.string.heads_up_title),
                    getString(R.string.hover_settings_title),
                    getString(R.string.voice_tts_title),
                    getString(R.string.lockscreen_notifications)};
        return titleString;
    }
}
