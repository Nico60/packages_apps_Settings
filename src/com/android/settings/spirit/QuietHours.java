...
import com.android.settings.spirit.service.QuietHoursController;
...
public class QuietHours extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getPreferenceManager() != null) {
            ...
            mQuietHoursEnabled.setSummary(mQuietHoursEnabled.getEntry());
    ...
    public void onResume() {
        ...
        if (mPreferencesChangeListener == null) {
            mPrefs.registerOnSharedPreferenceChangeListener(mPreferencesChangeListener);
        }
        if (mQuietHoursEnabled != null) mQuietHoursEnabled.setSummary(mQuietHoursEnabled.getEntry());
    }
